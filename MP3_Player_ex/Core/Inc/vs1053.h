...
#define	VS1053_XRST_PORT			GPIOC
#define	VS1053_XRST_PIN				GPIO_PIN_2
#define VS1053_XCS_PORT				GPIOC
#define VS1053_XCS_PIN				GPIO_PIN_1
#define VS1053_XDCS_PORT			GPIOC
#define VS1053_XDCS_PIN				GPIO_PIN_0
